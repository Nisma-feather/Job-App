...
import { View, Text, Alert, ScrollView, SafeAreaView, StyleSheet, Pressable } from 'react-native';
      ...
      for (const Doc of SnapData.docs) {
        try {
          ...
          fetchedApplications.push({
            ...
            role: jobData.jobrole // Fixed potential typo (jobrole -> jobRole)
          });
              ...
              <Text style={styles.title}>{job.role}</Text>
               <View style={{flexDirection:'row',gap:3}}>
                 <Octicons name="square-fill" color="blue" size={15} />
                  ...
                  <Pressable onPress={()=>setStatus(true)}><Text style={{color:'blue'}}>View status</Text></Pressable>
               </View>
               </View>
        {status && (<>
              {/* Step 1 - Applied */}
