        ...
        <View style={styles.content}>
          ...
          {activeTab === 'company' && (
            <>
              ...
              <View>
              <MaterialCommunityIcons name="web" color="#000" size={24} />
                <Text>Website</Text>
              </View>
              <View>
              <Ionicons name="location-outline" color="#000" size={24} />
                <Text>Headquarters</Text>
              </View>
              <View>
              <FontAwesome name="calendar" color="#000" size={24} />
                <Text>Founded</Text>
              </View>
              <View>
                <Text>size</Text>
                <Foundation name="torsos" color="#000" size={24} />
              </View>
